...
public class ChaingunMobRender extends EntityRenderer<ChaingunMobEntity> {
    ...
    private static final ResourceLocation SHELL_TEXTURE = MCDoom.modResource(
    ...
    @Override
    public void render(ChaingunMobEntity persistentProjectileEntity, float f, float g, PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int i) {
        ...
        var vertexConsumer = vertexConsumerProvider.getBuffer(
                RenderType.entityCutout(this.getTextureLocation(persistentProjectileEntity)));
