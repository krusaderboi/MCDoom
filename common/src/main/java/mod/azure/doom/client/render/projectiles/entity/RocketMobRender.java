...
public class RocketMobRender extends GeoEntityRenderer<RocketMobEntity> {
    ...
    protected int getBlockLightLevel(@NotNull RocketMobEntity entityIn, @NotNull BlockPos partialTicks) {
        return 15;
    }

    @Override
    public void preRender(PoseStack poseStack, RocketMobEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
