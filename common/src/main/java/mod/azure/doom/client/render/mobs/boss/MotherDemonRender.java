...
public class MotherDemonRender extends DoomMobRender<MotherDemonEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, MotherDemonEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
