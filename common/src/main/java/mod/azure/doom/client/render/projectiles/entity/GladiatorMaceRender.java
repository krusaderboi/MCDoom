...
public class GladiatorMaceRender extends GeoEntityRenderer<GladiatorMaceEntity> {
    ...
    protected int getBlockLightLevel(@NotNull GladiatorMaceEntity entityIn, @NotNull BlockPos partialTicks) {
        return 15;
    }

    @Override
    public void preRender(PoseStack poseStack, GladiatorMaceEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
