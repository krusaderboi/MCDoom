...
public class BarenBlastRender extends GeoEntityRenderer<BarenBlastEntity> {
    ...
    @Override
    protected int getBlockLightLevel(@NotNull BarenBlastEntity entityIn, @NotNull BlockPos partialTicks) {
        return 15;
    }

    @Override
    public void preRender(PoseStack poseStack, BarenBlastEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
