...
public class EnergyCellMobRender extends GeoEntityRenderer<EnergyCellMobEntity> {
    ...
    protected int getBlockLightLevel(@NotNull EnergyCellMobEntity entityIn, @NotNull BlockPos partialTicks) {
        return 15;
    }

    @Override
    public void preRender(PoseStack poseStack, EnergyCellMobEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
