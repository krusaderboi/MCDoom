...
public class ImpModel extends GeoModel<ImpEntity> {
    ...
    public ResourceLocation classic_model = MCDoom.modResource("geo/imp.geo.json");
    public ResourceLocation nightmareimp_model = MCDoom.modResource("geo/nightmareimp.geo.json");
    public ResourceLocation imp2016_model = MCDoom.modResource("geo/imp2016.geo.json");

    public ResourceLocation classic_texture = MCDoom.modResource("textures/entity/imp-texturemap.png");
    public ResourceLocation d64_texture = MCDoom.modResource("textures/entity/imp-64.png");
    public ResourceLocation nightmareimp_texture = MCDoom.modResource("textures/entity/nightmareimp-texture.png");
    public ResourceLocation imp2016_texture = MCDoom.modResource("textures/entity/imp2016.png");

    public ResourceLocation imp2016_animation = MCDoom.modResource("animations/imp2016.animation.json");
    public ResourceLocation imp_animation = MCDoom.modResource("animations/imp_animation.json");
