...
public class MechaZombieEntity extends DemonEntity implements SmartBrainOwner<MechaZombieEntity> {
    ...
    public static AttributeSupplier.@NotNull Builder createMobAttributes() {
        return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 40.0D).add(Attributes.MAX_HEALTH,
                MCDoom.config.mechazombie_health).add(Attributes.ATTACK_DAMAGE, 0.0D).add(Attributes.MOVEMENT_SPEED,
    ...
    @Override
    public List<ExtendedSensor<MechaZombieEntity>> getSensors() {
    ...
    @Override
    public BrainActivityGroup<MechaZombieEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<MechaZombieEntity> getIdleTasks() {
        return BrainActivityGroup.idleTasks(new FirstApplicableBehaviour<MechaZombieEntity>(
