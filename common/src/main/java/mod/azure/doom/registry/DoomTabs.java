...
public class DoomTabs {
    ...
    public static final Supplier<CreativeModeTab> EGGS_TAB = Services.COMMON_REGISTRY.registerCreativeModeTab(MCDoom.MOD_ID, "eggs",
            () -> Services.COMMON_REGISTRY.newCreativeTabBuilder().title(Component.translatable("itemGroup." + MCDoom.MOD_ID + ".eggs")).icon(
                    () -> new ItemStack(DoomItems.IMP_SPAWN_EGG.get())).displayItems((enabledFeatures, entries) -> {
    ...
    public static final Supplier<CreativeModeTab> BLOCKS_TAB = Services.COMMON_REGISTRY.registerCreativeModeTab(MCDoom.MOD_ID, "blocks",
            () -> Services.COMMON_REGISTRY.newCreativeTabBuilder().title(
                    Component.translatable("itemGroup." + MCDoom.MOD_ID + ".blocks")).icon(
                    () -> new ItemStack(DoomBlocks.BARREL_BLOCK.get())).displayItems((enabledFeatures, entries) -> {
    ...
    public static final Supplier<CreativeModeTab> POWERUP_TAB = Services.COMMON_REGISTRY.registerCreativeModeTab(MCDoom.MOD_ID, "powerup",
            () -> Services.COMMON_REGISTRY.newCreativeTabBuilder().title(
                    Component.translatable("itemGroup." + MCDoom.MOD_ID + ".powerup")).icon(
                    () -> new ItemStack(DoomItems.SOULCUBE.get())).displayItems((enabledFeatures, entries) -> {
    ...
    public static final Supplier<CreativeModeTab> ARMOR_TAB = Services.COMMON_REGISTRY.registerCreativeModeTab(MCDoom.MOD_ID, "armor",
            () -> Services.COMMON_REGISTRY.newCreativeTabBuilder().title(Component.translatable("itemGroup." + MCDoom.MOD_ID + ".armor")).icon(
                    () -> new ItemStack(DoomItems.DOOM_HELMET.get())).displayItems((enabledFeatures, entries) -> {
    ...
    public static final Supplier<CreativeModeTab> WEAPONS_TAB = Services.COMMON_REGISTRY.registerCreativeModeTab(MCDoom.MOD_ID, "weapons",
            () -> Services.COMMON_REGISTRY.newCreativeTabBuilder().title(
                    Component.translatable("itemGroup." + MCDoom.MOD_ID + ".weapons")).icon(
                    () -> new ItemStack(DoomItems.BFG_ETERNAL.get())).displayItems((enabledFeatures, entries) -> {
                ...
                entries.accept(DoomItems.UNMAKRY_BOLT.get());
